        ...
        <div style={{ display: 'block', width: '96vw', textAlign: 'center' }}  >
            <Table >
                <thead>
                    <tr>
                        {/* <th>*</th> */}
                        <th style={{ width: '200px', color: 'gray' }}>Student Name</th>
                        <th style={{ width: '200px', color: 'gray' }}>Course</th>
                        <th style={{ width: '200px', color: 'gray' }}>Degree</th>
                        <th style={{ width: '200px', color: 'gray' }}>University</th>
                        <th style={{ width: '200px', color: 'gray' }}>Year of Passing</th>
                        <th style={{ width: '200px', color: 'gray' }}><Button variant="outline-dark" className="add" onClick={() => { updateShowModal('add', true) }}>+</Button></th>
                    </tr>
                </thead>
                <tbody>
